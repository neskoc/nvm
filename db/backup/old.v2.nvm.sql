...
INSERT INTO "Object" ("ObjectId","name","title","data","author","gps","mapImage","image1","image1Alt","image1Text","TEXT","image2","image2Alt","image2Text") VALUES (1,'halvagen','01 Hålvägen','<h2>Hålvägen – stigen</h2>
...
-->
','Peter Öjerskog','GPS N56.19903° E15.54876° (P-plats N56.20387° E15.54759°)','01','01_halvagen.jpg',NULL,NULL,NULL,NULL,NULL,NULL),
...
-->
','Peter Öjerskog','GPS N56.21438° E15.53978°','03','03_varendsvagen.jpg','Värendsvägen','Värendsvägen i Nättraby var sedan 1500-talet en handelsväg som gick mellan det rika Värend i sydöstra Småland ner till Blekinges hamnar, exempelvis Nättrabyhamn. Unikt är att hela 4,6 kilometer av grusvägen är så välbevarad, särskilt förbi gården Marielund. Foto: Peter Öjerskog, 2008.',NULL,NULL,NULL,'Nord-sydliga värendsvägen mötte väst-östliga kustvägen men fortsatte sedan ner mot Nättrabyhamn (och vidare mot Vrängö vid Nättrabyåns mynning). Värendsvägen finns här kvar idag som asfalterad gång/cykelbana samt nuvarande Gamla Dalbyvägen. Husen i förgrunden finns kvar. 1910-talet. Fotograf okänd.
...
INSERT INTO "Article" ("ArticleId","name","title","data","author","gps","mapImage","image1","image1Alt","image1Text","TEXT","image2","image2Alt","image2Text") VALUES (1,'start','Nättraby Vägmuseum','<blockquote>
...
<p><img src="img/orig/stenbron.jpg" alt="Stenbron" /></p>
<p>Blekingekustvägens tvåvalviga stenbro över Nättrabyån är symbolen
för Nättraby Vägmuseum. Den så kallade Landbron uppfördes i början
av 1800-talet, togs ur bruk 1934 då biltrafiken blev för intensiv och tung, samt renoverades 1974. Fotograf: Kjell Warnquist, 2008.</p>

<p><img src="img/orig/vykort.jpg" alt="Gammalt vykort med en bil hälsar dig välkommen till Nättraby" /></p>
...
','Peter Öjerskog','GPS N56.20783° E15.53065°',NULL,'tva-valvig-stenbro-over-nattrabyan.jpg','Tvåvalvig stenbro över Nättrabyån','Blekingekustvägens tvåvalviga stenbro över Nättrabyån är symbolen för Nättraby Vägmuseum. Den så kallade Landbron uppfördes i början av 1800-talet, togs ur bruk 1934 då biltrafiken blev för intensiv och tung, samt renoverades 1974. Fotograf: Kjell Warnquist, 2008.',NULL,NULL,NULL,NULL),
 (2,'nattraby-vagmuseum','Om Nättraby Vägmuseum','<h2>Världens första friluftsmuseum för vägarnas historia på land, räls, vatten och is</h2>
...
','Peter Öjerskog','GPS N56.20783° E15.53065°',NULL,'gamla-landsvagen.jpg','Skylt Gamla Landsvägen','Det gamla vägnamnet lever kvar på dagens vägnamnskyltar, som här i korsningen länsväg 679/länsväg 678. Väst-östgående länsväg 679 heter fortfarande Gamla Landsvägen förbi Nättraby eftersom det var här som landsvägen gick. Foto: Peter Öjerskog, 2008.',NULL,NULL,NULL,NULL),
 (3,'kartor','Kartor','<h2>01&#160;Hålvägen</h2>
...
','Peter Öjerskog',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (5,'sveriges-vaghistoria','Sveriges väghistoria','<p><img src="img/orig/tva-generationer-vagar.jpg" alt="Två generationer vägar" /></p>
...
','Peter Öjerskog',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (6,'om-vagmuseum','Nättraby Vägmuseum - om tillkomsten','<blockquote>
  <p>Världens första friluftsmuseum för vägarnas historia på land, räls, vatten och is.</p>
</blockquote>
...
','Peter Öjerskog',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (7,'om-vagmuseum-natet','Nättraby Vägmuseum ute på nätet','<p>Nättraby Vägmuseum är nu ute på Internet. På hemsidan www.nattrabyvagmuseum.se finns information, bilder och kartor på Sveriges och världens första friluftsmuseum för vägarnas historia på land, räls, vatten och is.</p>
...
','Peter Öjerskog',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (8,'om-projektet','Om projektet Nättraby vägmuseum','<p>När projektet om Nättraby vägmuseum genomfördes så fanns det en stor del intressenter inblandade i projektet. Projektledare var Peter Öjerskog och orförande i styrgruppen var Ingegerd Holm från Nättraby Hembygdsförening.</p>
...
','Peter Öjerskog',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (9,'om-invigning','Nättraby vägmuseum invigt 2014','<p>– världens första friluftsmuseum för vägarnas historia på land, räls, vatten och is.</p>
...
','Peter Öjerskog','GPS N56.20783° E15.53065°',NULL,'skylt-vagmuseum.jpg','Skylt vägmuseum','Nättraby Vägmuseum har officiellt invigts genom att en stor skylt med information på båda sidor satts upp på rastplatsen nära den gamla stenbron vid E22 väster om Karlskrona. I en låda på skylten finns även broschyrer. Foto: Peter Öjerskog, 2014.',NULL,NULL,NULL,NULL),
 (10,'kontakt','Kontakt','<p>Nättraby Hembygdsförening i Blekinge har tillsammans med intressenter skapat Nättraby Vägmuseum.</p>
...
','Peter Öjerskog',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (11,'kallor','Källor','<h2>Litteratur och tryckta källor</h2>
